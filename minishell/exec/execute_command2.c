...
/*   Updated: 2025/08/07 17:38:12 by muharsla         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	redirect_output(const char *file, int append)
{
	int	fd;
...
static void	child_directory(t_command *cur, char *f, char **envp)
{
	if (f)
	{
		if (is_directory(f))
